...
func (s *NotificationService) GetMyNotifications(user *models.User) ([]models.Notification, error) {
	s.SyncNotifications(user)
	return s.repo.GetUserNotifications(user.ID)
}
